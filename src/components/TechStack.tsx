...
const securityTools = [
  { name: "Wireshark", icon: "/placeholder.svg", isText: true },
  { name: "Metasploit", icon: "/placeholder.svg", isText: true },
  { name: "Nmap", icon: "/placeholder.svg", isText: true },
  { name: "Burp Suite", icon: "/placeholder.svg", isText: true },
  { name: "KernelSU", icon: "/placeholder.svg", isText: true },
  { name: "Binwalk", icon: "/placeholder.svg", isText: true },
  { name: "Autopsy", icon: "/placeholder.svg", isText: true },
  { name: "Boot.img Patching", icon: "/placeholder.svg", isText: true },
  { name: "Privilege Escalation", icon: "/placeholder.svg", isText: true },
  { name: "Digital Forensics", icon: "/placeholder.svg", isText: true },
];
      ...
      >
              ...
              >
                <div className="w-20 h-20 rounded-xl bg-card border border-border flex items-center justify-center p-4 transition-all duration-300 group-hover:border-primary/50 group-hover:shadow-[0_0_20px_rgba(var(--primary-rgb),0.2)]">
                  <img
                    src={tech.icon}
                    alt={tech.name}
                    className="w-10 h-10 object-contain filter brightness-0 invert opacity-70 group-hover:opacity-100 transition-opacity duration-300"
                  />
                </div>
        ...
        <div className="relative overflow-hidden">
          <div className="flex animate-scroll-right">
            {[...securityTools, ...securityTools].map((tool, index) => (
              <div
                key={`${tool.name}-${index}`}
