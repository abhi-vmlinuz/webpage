...
const skills = [
  { icon: Shield, label: "Security Engineering", description: "Penetration testing, vulnerability assessment, secure architecture" },
  { icon: Terminal, label: "Linux & Automation", description: "Shell scripting, Ansible, system administration" },
  { icon: Cloud, label: "Cloud & DevOps", description: "AWS, Docker, Kubernetes, CI/CD pipelines" },
  { icon: Lock, label: "DevSecOps", description: "Security-first development, SAST/DAST, compliance" },
  { icon: Server, label: "Infrastructure", description: "Terraform, platform engineering, monitoring" },
  { icon: Code, label: "Backend Systems", description: "Python, Go, APIs, microservices" },
];
      ...
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            <p className="text-secondary-foreground text-lg leading-relaxed">
              Whether it's architecting <span className="highlight-accent">CTF platforms</span>, 
              automating security workflows, or designing <span className="highlight-primary">zero-trust networks</span>, 
